<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" ref="table" :data="data" size="small" border style="width: 100%;">
      ...
      <el-table-column prop="vm_name" label="IP/域名" width="150"/>
...
export default {
  ...
  methods: {
    ...
    toAdd() {
      ...
      this.$refs.form.form = { vm_name: '', auth_type: null, username: '', password: '', port: '', desc: '' }
    ...
    toEdit(id) {
      ...
      retrieve(id).then(res => {
        ...
        this.$refs.form.form.vm_name = res.vm_name
