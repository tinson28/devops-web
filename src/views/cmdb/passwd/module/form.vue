<template>
  <el-dialog :append-to-body="true" :visible.sync="dialog" :title="isAdd ? '新增密码' : '编辑密码'" width="550px">
    <el-form ref="form" :model="form" :rules="rules" size="small" label-width="100px">
      <el-form-item label="实例名称" prop="vm_name">
        <el-input v-model="form.vm_name" style="width: 370px;"/>
      </el-form-item>
      ...
      <el-form-item label="密码/KEY" prop="password">
        <el-input v-model="form.password" style="width: 370px;" show-password/>
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    resetForm() {
      ...
      this.form = { vm_name: '', auth_type: null, username: '', password: '', is_public: 'false', port: 0, desc: '' }
    }
  }
}
</script>
