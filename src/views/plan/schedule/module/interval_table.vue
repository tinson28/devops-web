 ...
 <el-table v-loading="loading" ref="interval_tables" :data="data" highlight-current-row size="small" border style="width: 100%;" >
          <el-table-column prop="every" label="间隔"/>
...
import { delInterval } from '@/api/schedule'
export default {
  name: 'Interval',
  ...
  methods: {
    ...
    checkPermission,
    beforeInit() {
      this.url = 'api/interval_schedule/'
      const sort = 'id'
